...
const ProtectedLeftDrawerContent = (props) => {
  return (
    <View>
      ...
      <Drawer.Section style={styles.drawerSection}>
        <DrawerItem
          icon={({ color, size }) => <MaterialCommunityIcons name="pencil-plus-outline" color={color} size={size} />}
          label="New Post"
      ...
      <Drawer.Section style={styles.drawerSection}>
        <DrawerItem
          icon={({ color, size }) => <MaterialCommunityIcons name="settings" color={color} size={size} />}
          label="Settings"
...
const PublicLeftDrawerContent = () => {
  return (
    <Drawer.Section style={styles.drawerSection}>
      <DrawerItem
        icon={({ color, size }) => <MaterialCommunityIcons name="login" color={color} size={size} />}
        label="Sign In"
...
export default function LeftDrawerContent(props) {
  ...
  console.log('DEBUG: LeftDrawerContent: props')
  const [isSiggnedIn, setisSignedIn] = useState(true)

  return (
    <DrawerContentScrollView {...props}>
      <View style={styles.drawerContent}>
        {isSiggnedIn ? <ProtectedLeftDrawerContent {...props} /> : <PublicLeftDrawerContent {...props} />}
